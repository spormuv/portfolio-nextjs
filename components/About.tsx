  ...
  return (
    <section id='about' className='w-full px-6 pt-28 flex items-center'>
      <div className='max-w-[1240px] m-auto md:grid md:grid-cols-2 lg:grid-cols-3 gap-8'>
        ...
        >
          <div className='relative w-full h-auto m-auto shadow-md shadow-gray-370 rounded-full flex items-center justify-center hover:scale-105 ease-in duration-300 aspect-square'>
            <Image
